...
请注意、在AWS中手动安装Connector软件之前、Amazon EC2实例需要使用实例元数据服务版本1 (IMDSv1)。

https://docs.netapp.com/us-en/bluexp-setup-admin/reference-limitations.html["详细了解AWS中的IMDSv1要求"]。
